...
public class VisitorRegisterActivity extends AppCompatActivity implements  CenterDialog.OnCenterItemClickListener, BottomDialog.OnBottomItemClickListener{
    ...
    public void OnBottomItemClick(BottomDialog dialog, View view) {
        switch (view.getId()) {
            case R.id.photo_dialog_camera:
                dialog.dismiss();
                Toast.makeText(VisitorRegisterActivity.this, "相机", Toast.LENGTH_SHORT).show();
                break;
            case R.id.photo_dialog_photo:
                dialog.dismiss();
                Toast.makeText(VisitorRegisterActivity.this, "相册", Toast.LENGTH_SHORT).show();
                break;
